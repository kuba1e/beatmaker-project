class DrumKit {
    constructor(){
        ...
        this.tempoValue = document.querySelector('.tempo-number');
    }
    ...
    start() {
        ...
        //check is this playing
        if(this.isPlaying ) {
            clearInterval(this.isPlaying);
            this.isPlaying = null;
        }
        else{
            this.isPlaying = setInterval(()=> {this.repeate()}, interval)} 
...
drumKit.playBtn.addEventListener('click', function(){ drumKit.start()});
drumKit.playBtn.addEventListener('click', function(){ drumKit.updateBtn()});
